...
public class ChangePassword extends  CustomedFrame {
    ...
    public ChangePassword(IUsersService usersService) {
        ...
        this.userName = LoginFrame.USER_NAME;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            boolean isCorrectUser = user.verify(userName, oldPassword);
            
            if(isCorrectUser){
                if(newPassword1.equals(newPassword2)){
                    if(service.checkPasswordComplexity(newPassword2)){
                       service.ChangePassword(userName, oldPassword, newPassword2);
                        setVisible(false);
                     } else {
                       jLabel5.setText("Please enter minimum 5 characters");
                    }
                }else{
                    jLabel7.setText("New Password does not match old"); 
                }
            }else {

...
public class DiscountReport extends CustomedFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DiscountReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new DiscountReport(new DiscountsService(new UnitOfWork())).setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(DiscountReport.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
